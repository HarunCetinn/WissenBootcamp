...
//DateTime gununTarihi = DateTime.Today;
//DateTime gununZamani = DateTime.Now;
//DateTime gununZamaniUTC = DateTime.UtcNow;
...
double sayi = 14.5234;
double yuvarlananSayiRound = Math.Round(sayi);
double yuvarlananSayiFlour = Math.Floor(sayi);
double yuvarlananSayiCeiling = Math.Ceiling(sayi);
...
//double sayi = 7;
//double ustAlinanSayi = Math.Pow(sayi, 4);
